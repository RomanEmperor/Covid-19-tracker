...
//  Covid
//
//  Created by Roman Parajuli on 9/2/20.
    ...
    var body: some View {
                                ...
                                VStack(spacing: 10) {
                                    ...
                                    GeometryReader { g in
                                        VStack {
                                            ...
                                            .fill(Color("death"))
                                                .frame(width: 15,
                                                       height: self.getHeight(value: i.cases,
                                                                              height: g.frame( in : .global).height))
        ...
        .alert(isPresented: self.$alert, content: {
            Alert(title: Text("Error"),
                  message: Text("Invalid Country Name"),
